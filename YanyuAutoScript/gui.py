...
class MainWindow(Tk):
    ...
    def ku_gu(self):
        ...
        print("""进入副本开刷""")
        self.device.click(0.802, 0.592)
        time.sleep(5)
        self.device.click(0.548, 0.187)
        time.sleep(5)
        self.device.click(0.208, 0.092)
        time.sleep(5)
        self.device.click(0.778, 0.804)
        time.sleep(5)
        self.device.click(0.67, 0.585)
        time.sleep(5)
        self.device.click(0.812, 0.372)
        time.sleep(5)
        self.device.click(0.676, 0.45)
        time.sleep(5)
        self.device.click(0.566, 0.205)
        time.sleep(5)
        self.device.click(0.76, 0.187)
        time.sleep(5)
        self.device.click(0.6, 0.634)
        time.sleep(5)
        self.device.click(0.6, 0.138)
        time.sleep(5)
        self.device.click(0.774, 0.287)
        time.sleep(5)
        self.device.click(0.48, 0.414)
        time.sleep(5)
        self.device.click(0.662, 0.262)
        time.sleep(5)
        self.device.click(0.152, 0.539)
        time.sleep(5)
        self.device.click(0.604, 0.432)
        time.sleep(12)
    ...
    def tian_yi(self):
        ...
        time.sleep(8)
        print("""进入副本刷怪""")
        self.device.click(0.762, 0.79)
        time.sleep(5)
        self.device.click(0.656, 0.595)
        time.sleep(5)
        self.device.click(0.774, 0.801)
        time.sleep(5)
        self.device.click(0.722, 0.539)
        time.sleep(5)
        self.device.click(0.528, 0.184)
        time.sleep(5)
        self.device.click(0.318, 0.102)
        time.sleep(5)
        self.device.click(0.212, 0.088)
        time.sleep(5)
        self.device.click(0.774, 0.209)
        time.sleep(5)
        self.device.click(0.444, 0.595)
        time.sleep(5)
        self.device.click(0.608, 0.429)
        time.sleep(12)
    ...
    def tie_ren(self):
        ...
        time.sleep(12)
        print("""进入副本开刷""")
        self.device.click(0.204, 0.276)
        time.sleep(5)
        self.device.click(0.72, 0.244)
        time.sleep(5)
        self.device.click(0.716, 0.237)
        time.sleep(5)
        self.device.click(0.658, 0.287)
        time.sleep(5)
        self.device.click(0.376, 0.248)
        time.sleep(5)
        self.device.click(0.658, 0.492)
        time.sleep(5)
        self.device.click(0.664, 0.4)
        time.sleep(5)
        self.device.click(0.44, 0.684)
        time.sleep(5)
        self.device.click(0.612, 0.421)
        time.sleep(12)
        print("""回泰山""")
        self.device.click(0.208, 0.946)
        time.sleep(2)
